...
Welcome to the latest stable release of wxWidgets, a free and open source
...
the docs subdirectory appropriate for the platform you use. e.g.
...
However, if you distribute wxGTK or wxMotif (with Lesstif) version of your
application, don't forget that it is linked against GTK+ or Lesstif, which
